...
// Wipes all rides, pools and payments and re-seeds the story cast (with
// yesterday's shared trip for the history screens), so a demo
...
try {
  ...
  logger.info({ ...result, demoHistory: history.created }, 'Demo data reset');
} catch (err) {
